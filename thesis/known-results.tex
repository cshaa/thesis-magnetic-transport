...
\citet{Macris1999} investigated the problem of Landau Hamiltonians with a steep (but locally integrable) potential wall along the edge of a half-plane. What follows is a summary of their results.
...
\begin{thm}[Asymptotically flat]
    ...
    \begin{equation*}
        ...
        \;\: ,
    \end{equation*}
    where $g(\alpha, \ve) := \sqrt{\alpha^2 + \alpha \, \ve \, \sqrt{1-\alpha^2}}$, holds for some $\ve$ such that
    \begin{equation*}
        0
        \,<\,
        \ve
