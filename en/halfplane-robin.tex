...
\begin{figure}[p]
    ...
    \caption{The first energy levels $\epsilon$ as a function of the $y$-momentum $p$ for $\alpha\,\sqrt{2b} = 0.0, 0.5, 0.8, 1.0, 1.2$ and $2.0$ (starting with a system with Dirichlet b.c.).}
